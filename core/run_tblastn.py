...
def run_tblastn(
    ...
    try:
        subprocess.run(
            mask_cmd, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE
        )
    ...
    try:
        subprocess.run(
            makeblastdb_cmd, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE
        )
    ...
    try:
        subprocess.run(
            tblastn_cmd, check=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE
        )
